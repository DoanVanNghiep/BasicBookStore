...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/bookstore_style.css">
					...
					<tr>
						...
						<td>
							...
							<div id ="div${orderOfCustomer.orderId}" style="display: none;">
								...
								<table border="1">
									...
									<c:forEach items="${orderOfCustomer.orderBookList}" var="cartItem">
										<tr>
											...
											<td><fmt:formatNumber type="number" maxFractionDigits="0" value="${cartItem.selectedBook.price}"></fmt:formatNumber><sup>đ</sup></td>
											<td>${cartItem.quantity}</td>
											<td> <fmt:formatNumber type="number" maxFractionDigits="0" value="${cartItem.selectedBook.price * cartItem.quantity}"></fmt:formatNumber><sup>đ</sup></td>
										</tr>
									</c:forEach>
								</table>
								<br>
								Tổng số tiền:
								<b>
									<span> <fmt:formatNumber type="number" maxFractionDigits="0" value="${orderOfCustomer.totalCost}"></fmt:formatNumber>										
									 </span>
									 <sup>đ</sup>
								</b>
							</div>
